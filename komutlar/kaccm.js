...
exports.run = (client, message) => {
  if (message.author.id === ayarlar.sahip) {
    message.channel.send('** O Kadar haşmetlisin ki ölçemedik reis.(yalarım onu ben ham  yaparım)** :eggplant:')
  }else{               
...
exports.help = {
  name: 'kaçcm',
  description: 'Aletin Gökdelen mi G*tdelen mi olduğunu gösterir.',
  usage: 'kaçcm'
};